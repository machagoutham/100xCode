    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#2f65e1] flex items-center gap-2">
                <Plus size={24} className="text-[#2f65e1]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer
                          ...
                          ${
                            selectedTemplate === template.id
                              ? "border-[#2f65e1]  shadow-[0_0_0_1px_#2f65e1,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "hover:border-[#2f65e1] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }`}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#2f65e1] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#2f65e1] hover:bg-[#4482ed]"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#2f65e1]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#2f65e1,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#2f65e1]" />
