...
export default function Home() {
  ...
  return (
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      ...
      <h1 className=" z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-[#98c4f8] via-[#2650cf] to-[#2543a8] dark:from-[#98c4f8] dark:via-[#2650cf] dark:to-[#2543a8] tracking-tight leading-[1.3] ">
        100x Code
        <br/>
         Because 10x is not enough
      </h1>
      </div>
     

      <p className="mt-2 text-lg text-center text-gray-600 dark:text-gray-400 px-5 py-10 max-w-2xl">
        100xCode is a powerful and intelligent code editor that enhances
